const SpanishFlagIcon = () => {
  return (
    <svg viewBox="0 0 512 336" xmlns="http://www.w3.org/2000/svg">
      <g fill="none">
        <path
          d="M8.828 335.724h494.345a8.829 8.829 0 0 0 8.828-8.828V9.103a8.829 8.829 0 0 0-8.828-8.828H8.828A8.83 8.83 0 0 0 0 9.103v317.793a8.828 8.828 0 0 0 8.828 8.828z"
          fill="#C8414B"
        />
        ...
        />
        <path
          d="M114.759 141.517a8.829 8.829 0 0 0-8.828 8.828v57.379c0 10.725 10.01 30.897 44.138 30.897s44.138-20.171 44.138-30.897v-57.379a8.829 8.829 0 0 0-8.828-8.828h-70.62z"
          fill="#F5F5F5"
        />
        <path
          d="M150.069 185.655h-44.138v-35.31a8.829 8.829 0 0 1 8.828-8.828h35.31v44.138zm0 0h44.138v22.069c0 12.189-9.88 22.069-22.069 22.069-12.189 0-22.069-9.88-22.069-22.069v-22.069z"
          fill="#C8414B"
        />
        <path
        ...
        <path
          d="M176.552 203.31v4.414a4.419 4.419 0 0 1-4.414 4.414 4.419 4.419 0 0 1-4.414-4.414v-4.414h8.828zm8.827-8.827h-26.483v13.241c0 7.302 5.94 13.241 13.241 13.241 7.302 0 13.241-5.94 13.241-13.241v-13.241h.001z"
          fill="#FAB446"
        />
        <path
          d="M172.138 176.828A8.829 8.829 0 0 1 163.31 168v-8.828a8.829 8.829 0 0 1 17.656 0V168a8.829 8.829 0 0 1-8.828 8.828z"
          fill="#FFA0D2"
        />
        <circle fill="#5064AA" cx="150.069" cy="185.655" r="13.241" />
        <path fill="#FAB446" d="M145.655 88.552h8.828v26.483h-8.828z" />
        <path
          d="M123.586 132.69l-8.828-8.828 5.171-5.171a42.625 42.625 0 0 1 60.28 0l5.171 5.171-8.828 8.828h-52.966z"
          fill="#C8414B"
        />
